...
import { HospitalProcedureGroupInsert } from "@/components/baseTables/hospitalProcedureGroup/types";
...
const prop = defineProps({
  ...
  data: {
    type: Object as PropType<HospitalProcedureGroupInsert>,
    required: true,
  },
  error: {
    type: String,
...
const requiredRules = {
  name: [(v: string) => !!v?.trim() || t("t-please-enter-name-hospital-procedure-group")],
};
...
<template>
  <v-dialog v-model="dialogValue" width="500" scrollable>
    <v-form ref="form" @submit.prevent="onSubmit">
      <Card :title="isCreate ? $t('t-add-hospital-procedure-group') : $t('t-edit-hospital-procedure-group')"
