...
const budgetFormData = ref<BudgetInsertType | null>(null);
        ...
        <v-card-text>
          ...
          <v-row class="mt-n6">
            <v-col cols="12" lg="6">
              ...
              <ValidatedDatePicker v-model="data.startDate" :placeholder="$t('t-enter-start-date')" />
            </v-col>
            <v-col cols="12" lg="6">
              <div class="font-weight-bold text-caption mb-1">
                {{ $t('t-end-date') }} <i class="ph-asterisk ph-xs text-danger" />
              </div>
              <ValidatedDatePicker v-model="data.endDate" :placeholder="$t('t-enter-end-date')" />
            </v-col>
          </v-row>
          <v-row class="">
