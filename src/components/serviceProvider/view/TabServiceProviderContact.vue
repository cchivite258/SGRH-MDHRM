      ...
      <v-card-text class="pt-0">
        ...
        <v-row class="mt-2">
          <v-col cols="12" lg="6">
            ...
            <div>{{ serviceProviderData.incomeTaxNumber || '-' }}</div>
          </v-col>
          ...
          <v-col cols="12" lg="6">
            ...
            <div>{{ serviceProviderData.personOfContactFullname1 || '-' }}</div>
          </v-col>
        </v-row>
        ...
        <v-row class="">
          <v-col cols="12" lg="6">
            ...
            <div>{{ serviceProviderData.personOfContactPhone1 || '-' }}</div>
          </v-col>
          ...
          <v-col cols="12" lg="6">
            ...
            <div>{{ serviceProviderData.personOfContactEmail1 || '-' }}</div>
          </v-col>
        </v-row>
        ...
        <v-row class="">
          <v-col cols="12" lg="6">
            ...
            <div>{{ serviceProviderData.personOfContactFullname2 || '-' }}</div>
          </v-col>
          ...
          <v-col cols="12" lg="6">
            ...
            <div>{{ serviceProviderData.personOfContactPhone2 || '-' }}</div>
          </v-col>
        </v-row>
        ...
        <v-row class="">
          <v-col cols="12">
            ...
            <div>{{ serviceProviderData.personOfContactEmail2 || '-' }}</div>
          </v-col>
        </v-row>
      </v-card-text>
