...
import ReportPreview from "@/components/ammReports/list/CostPerEmployeeReport/PreviewReport.vue";
import ReportPreviewShell from "@/components/ammReports/list/ReportPreviewShell.vue";
import { useRouter } from "vue-router";

const store = useCostPerEmployeeStore();
...
<template>
  <ReportPreviewShell current-report-id="100002" :report="store.report">
